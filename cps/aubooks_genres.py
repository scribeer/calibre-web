...
EXTRA_ALIASES = {
    ...
    # Wave 5 — 86 HIGH-confidence aliases from read-only audit (2026-09-08)
    # Романтика
    "Любовные рассказы": "love",
    "Эротика и любовь": "love_erotica",
    "Любовь и эротика": "love_erotica",
    "Любовно-историческая проза": "love_history",
    "Любовная фантастика": "love_sf",
    "Любовная история": "love_history",
    "Короткие любовные истории": "love_short",
    "Мелодрама": "love",
    # Деловая литература
    "Популярно о бизнесе": "popular_business",
    "Бизнес": "economics_ref",
    "Экономика": "economics",
    "О бизнесе популярно": "popular_business",
    "Маркетинг": "org_behavior",
    "Экономика и бизнес": "economics",
    "foreign_business": "economics_ref",
    "Карьера": "popular_business",
    # Психология и здоровье
    "Личностный рост": "sci_psychology_popular",
    "psy_generic": "sci_psychology_popular",
    "psy_sex_and_family": "sci_psychology_popular",
    "psy_social": "sci_psychology_popular",
    "Психологія": "sci_psychology",
    "Психологія та бізнес": "sci_psychology",
    # Фантастика
    "Русское фэнтези": "sf_fantasy",
    "urban_fantasy": "sf_fantasy_city",
    "Мистическая фантастика": "sf_mystic",
    ...
    "Иностранная фантастика": "foreign_sf",
    "Эпическая фантастика": "sf_epic",
    "Фентезі": "sf_fantasy",
    "Попаданцы в магические миры": "popadancy",
    "Фэнтези про драконов": "sf_fantasy",
    "Зарубежная фантастика": "foreign_sf",
    "Попаданцы во времени": "popadancy",
    "Попаданцы в другие миры": "popadancy",
    "Мистика и ужасы": "sf_mystic",
    "Попаданцы в космосе": "popadancy",
    "magician_book": "sf_fantasy",
    "українска фантастика": "sf_fantasy",
    "Ужасы для детей": "children",
    "Фантастика для детей": "children",
    "дитяче фентезі": "children",
    "фентезі для дітей": "children",
    ...
    # Детская литература
    "Обучение детей": "child_education",
    "Детский детектив": "child_det_children_detectives",
    "дитяча література": "children",
    "Дитячі казки": "child_tale",
    "Детские детективы": "child_det_children_detectives",
    "Приключения с детьми": "child_adv",
    "Пригоди для дітей": "child_adv",
    # Документальная литература
    "foreign_publicism": "nonf_publicism",
    "Биографии": "nonf_biography_celebrities",
    "Публіцистика": "nonf_publicism",
    "География": "travel_notes",
    "Публицистика: прочее": "nonf_publicism",
    "біографія": "nonf_biography",
    "Українська культура": "art_world_culture",
    # Наука и образование
    "История и биографии": "sci_history",
    "історія": "sci_history",
    "Педагогика": "sci_pedagogy",
    "Политика и социология": "sci_politics",
    "Языкознание": "sci_linguistic",
    "Історія та культура": "sci_history",
    "Политика и политология": "sci_politics",
    "Экономика и политика": "sci_economy",
    "История цивилизации": "sci_history",
    "Альтернативные науки": "sci_theories",
    # Проза
    "novel": "prose",
    "Современная зарубежная литература": "foreign_prose",
    "Современная русская литература": "prose_contemporary",
    "Роман": "prose",
    "сучасна проза": "prose_contemporary",
    "Сетевая литература": "prose",
    "foreign_edu": "foreign_prose",
    "Иностранная проза": "foreign_prose",
    "foreign_home": "foreign_prose",
    "Сучасна література": "prose_contemporary",
    "Літературно-художнє видання": "prose",
    "Историческая литература": "prose",
    "історична проза": "prose",
    "Історична література": "prose",
    "українська література": "prose",
    # Приключения
    "Путешествия": "adv_geo",
    "Вестерн": "adv_indian",
    "Приключения с животными": "adv_animal",
    # Религия и духовность
    "religion_rel": "religion",
    "Религия": "religion",
    "езотеріка": "religion_esoterics",
    # Дом и семья
    "Кулинария и здоровье": "home_cooking",
    "Хобби": "home_crafts",
    # Фольклор
    "Фольклор": "folklore",
