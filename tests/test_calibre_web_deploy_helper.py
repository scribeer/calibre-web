...
class DeployHelperTest(unittest.TestCase):
    ...
    def write_bundle(self, manifest_sha=VALID_SHA):
        ...
        manifest = {
            ...
            "tts_processor_base64": base64.b64encode(tts_content.encode("utf-8")).decode("ascii"),
...
class DispatcherUploadTest(unittest.TestCase):
    ...
    def test_upload_sets_helper_executable(self):
        ...
        for name in (self.wheel_name, "SHA256SUMS", "artifact-manifest.json", "deploy-request.json", "sync-audio-db.sh"):
